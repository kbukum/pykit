...
# Creating a branch for pykit work
...
- **Prefix with `kbukum/`**, then a short kebab-case summary of the change:
  `kbukum/<short-change-summary>` (e.g. `kbukum/harden-subprocess-argv-validation`).
- Name by the actual change: the package/capability touched and the outcome
  (`kbukum/component-lifecycle-drain`, `kbukum/storage-s3-multipart`).
