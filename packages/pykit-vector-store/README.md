...
```bash
pip install pykit-vector-store
# or
uv add pykit-vector-store
...
```python
from pykit_vector_store import (
...
```python
from pykit_vector_store.qdrant import QdrantVectorStore, QdrantConfig
