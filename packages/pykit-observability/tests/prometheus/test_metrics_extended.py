"""Extended tests for pykit-observability: metric values, labels, edge cases."""
...
from pykit_observability.prometheus import start_metrics_server
...
class TestStartMetricsServerExtended:
    def test_thread_is_daemon(self) -> None:
        ...
        with patch("pykit_observability.prometheus.start_http_server"):
    ...
    def test_custom_port(self) -> None:
        with patch("pykit_observability.prometheus.start_http_server") as mock_start:
