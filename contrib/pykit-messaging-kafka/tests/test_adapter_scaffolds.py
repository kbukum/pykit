...
from pykit_messaging_kafka import KafkaConfig, KafkaConsumer, KafkaProducer
from pykit_messaging_kafka import register as register_kafka
from pykit_messaging_nats import NatsConfig, NatsConsumer, NatsProducer
from pykit_messaging_nats import register as register_nats
from pykit_messaging_rabbitmq import (
    RabbitMqConfig,
    RabbitMqConsumer,
    RabbitMqProducer,
)
...
assert "pykit_messaging_kafka" not in sys.modules
assert "pykit_messaging_nats" not in sys.modules
assert "pykit_messaging_rabbitmq" not in sys.modules
...
builtins.__import__ = guarded_import
import pykit_messaging_kafka
import pykit_messaging_nats
import pykit_messaging_rabbitmq
