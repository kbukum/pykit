...
Vendor-specific implementations live in split packages: **pykit-llm-openai**, **pykit-llm-anthropic**, and **pykit-llm-gemini**:
...
from pykit_llm_openai import OpenAIConfig, OpenAIProvider
