...
from pykit_messaging_kafka import KafkaConfig, register as register_kafka
...
standalone adapter packages; core and memory imports do not pull optional SDKs into the runtime graph.
